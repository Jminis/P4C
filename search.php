            ...
            <p>
                ...
                <table >
                    ...
                    <tbody>
                        ...
                        $sssql = $ssql." ORDER BY idx DESC LIMIT $page_start, $list";
               ...
               <?php
               if ($page > 1) echo "<a href='search.php?".(isset($track) ? "track=".$track."&" : "")."page=1'>처음</a>";
               for($i = $block_start; $i <= $block_end; $i++){
                   if($page == $i){  echo "<b> $i </b>";  }
                   else {  echo "<a href='search.php?".(isset($track) ? "track=".$track."&" : "")."page=$i'> $i </a>"; }
               }
               if($page < $total_page) echo "<a href='search.php?".(isset($track) ? "track=".$track."&" : "")."page=$total_page'>마지막</a>";
               ?>
               </div>
            </div>
        </div>
